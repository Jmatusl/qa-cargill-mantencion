...
import { useGetAllNotificationsByMaintenance } from "@/hooks/useQueriesNotifications";
...
export function NotificationsTab({ data }: { data: any }) {
  const {
    data: notifications,
    isLoading,
    isError,
    isFetching,
  } = useGetAllNotificationsByMaintenance(data.id);
